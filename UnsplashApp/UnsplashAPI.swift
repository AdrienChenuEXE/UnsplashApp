...
func feedUrl(orderBy: String = "popular", perPage: Int = 10, path UrlPath : String = "/photos") -> URL? {
    var components = unsplashApiBaseUrl(path: UrlPath)  // Utilise la fonction précédemment définie pour la base de l'URL
